...
exports.getPathAfterDomain = getPathAfterDomain;
exports.createRegexOption = createRegexOption;
exports.createCommand = createCommand;
exports.openOptions = openOptions;
exports.getCurrentTab = getCurrentTab;
exports.getOptionsAsync = getOptionsAsync;
exports.openInLocalhost = openInLocalhost;
exports.executeRegexCommand = executeRegexCommand;
...
function createRegexOption(restoredData = {}) {
    // creates container
...
function createCommand(name, shortcut) {
    const btn = document.createElement('button');
    btn.innerHTML = name;
...
// open in localhost
async function openInLocalhost() {
...
async function executeRegexCommand(pattern, replacement) {
    const tab = await getCurrentTab();
